...
$insertProfile = "UPDATE profiles set credit_card=:credit_card,expiry=:expiry,interests=:interests,language=:language,special_needs=:special_needs where user_id=:user_id";  
